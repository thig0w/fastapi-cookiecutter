...
from src.{{cookiecutter.app_slug}} import config, models
from src.{{cookiecutter.app_slug}}.db.session import get_db
from src.{{cookiecutter.app_slug}}.models.security import TokenData
